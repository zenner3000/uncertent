#ifndef CRYPTOFACILITIES_H
#define CRYPTOFACILITIES_H
...
class cryptofacilities
{
    public:
        ...
        const string wssdomain  = "wss://api.cryptofacilities.com:9999/websocket";
